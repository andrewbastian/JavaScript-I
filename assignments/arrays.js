...
let carYears= [];
inventory.forEach(i => carYears.push(i.car_years)
// let carYears = [];
// for (let i = 0; i < car_year.length; i++) {
//     return car_year[i];
//   }
console.log(carYears);
// let carYears = inventory.keys(car_year);
// console.log(carYears);

// ==== Challenge 5 ====
// The car lot manager needs to find out how many
// cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.
let oldCars = [];
for (let i = 0; i < inventory.length; i++){
  if (carYears[i] < 2000){
